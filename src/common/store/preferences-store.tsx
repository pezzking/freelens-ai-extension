...
export class PreferencesStore extends Common.Store.ExtensionStore<PreferencesModel> {
  ...
  @observable accessor freelensAgent: CompiledStateGraph<object, object, any, any, any, any> | undefined;
  // TODO replace any with the correct types
  @observable accessor mcpAgent: CompiledStateGraph<object, object, any, any, any, any> | undefined;
